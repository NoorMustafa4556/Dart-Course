// Write a program that prints the ASCII values of all the characters in a given string using a for loop. The program should take the input string from the user.
import 'dart:io';
