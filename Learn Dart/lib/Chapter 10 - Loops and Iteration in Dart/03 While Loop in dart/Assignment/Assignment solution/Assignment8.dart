// Write a program that calculates the factorial of a given number using a while loop. Prompt the user to enter a number, and then calculate and print its factorial.
