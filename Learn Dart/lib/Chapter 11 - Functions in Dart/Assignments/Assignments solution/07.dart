// Implement a function countWords that takes a string as a parameter and returns the number of words in that string. Assume that words are separated by spaces.
