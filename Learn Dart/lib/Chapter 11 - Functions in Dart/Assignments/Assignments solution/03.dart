// Write a function generateFibonacciSequence that takes an integer n as a parameter and generates the Fibonacci sequence up to the nth term. Return the sequence as a list.
